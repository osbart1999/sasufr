...
from .models import Subject, Staff,Dean, Hodd, Student, StudentResult
...
class EditResultView(View):
    def get(self, request, *args, **kwargs):
        ...
        resultForm.fields['subject'].queryset = Subject.objects.filter(dean=dean)
        context = {
            'form': resultForm,
    ...
    def get(self, request, *args, **kwargs):
        ...
        resultForm.fields['subject'].queryset = Subject.objects.filter(hodd=hodd)
        context = {
            'form': resultForm,
            'page_title': "Edit Student's Result"
        }
