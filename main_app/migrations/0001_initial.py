    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'HOD'), (2, 'Dean'), (3, 'Hodd'), (4, 'Staff'), (5, 'Student')], default=1, max_length=1)),
        ...
        migrations.CreateModel(
            name='NotificationHodd',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('hodd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.hodd')),
            ],
        ),
        migrations.CreateModel(
            name='NotificationDean',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dean', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.dean')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='dean',
            name='faculty',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main_app.faculty'),
        ),
        migrations.AddField(
            model_name='course',
            name='department',
